...
const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", path: "/dashboard/tpo" },
  { icon: User, label: "My Profile", path: "/dashboard/tpo/profile" },
...
const TPODashboardLayout = ({ children, title }: TPODashboardLayoutProps) => {
...
export default TPODashboardLayout;